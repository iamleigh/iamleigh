...
function iamleigh_css() {
    ...
    wp_register_style( 'iamui-grid', get_template_directory_uri() . '/assets/css/grid.css', false, DEPLOY_VERSION );
    wp_register_style( 'iamui-front', get_template_directory_uri() . '/assets/css/front.css', false, DEPLOY_VERSION );
